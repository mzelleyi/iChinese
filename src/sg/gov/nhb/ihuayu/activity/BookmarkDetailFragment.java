    ...
    public void onLoadFinished(Loader<Dictionary> loader, Dictionary data) {
		...
		mBtnPrev.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				BookmarkDetailFragment fragment = (BookmarkDetailFragment) fm.findFragmentByTag(MainActivity.fragment_tag_bookmark_detail);
				if (fragment != null) {
		...
		backBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (currentFragment == null) {
					...
					ft.replace(R.id.tab_content_bookmark, newFragment, MainActivity.fragment_tag_bookmark);
    ...
    public static void showDialog(int dialogType, boolean bSusscuss) {
    	switch (dialogType)
		{
			case MyDialogFragment.ADD_TO_BOOKMARK:
				...
				mCurrentDialog = MyDialogFragment.newInstance(parentActivity, MyDialogFragment.ADD_TO_BOOKMARK, false, false);
			...
			case MyDialogFragment.ADD_RESULT:
				...
				mCurrentDialog = MyDialogFragment.newInstance(parentActivity, MyDialogFragment.ADD_RESULT, bSusscuss,false);
			...
			case MyDialogFragment.REMOVE_FROM_BOOKMARK:
				...
				mCurrentDialog = MyDialogFragment.newInstance(parentActivity, MyDialogFragment.REMOVE_FROM_BOOKMARK, false, false);
			...
			case MyDialogFragment.REMOVE_RESULT:
				...
				mCurrentDialog = MyDialogFragment.newInstance(parentActivity, MyDialogFragment.REMOVE_RESULT, bSusscuss, false);
