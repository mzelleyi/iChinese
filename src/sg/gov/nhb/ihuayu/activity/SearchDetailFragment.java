    ...
    public void onLoadFinished(Loader<Dictionary> loader, Dictionary data) {
        ...
        mBtnPrev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SearchDetailFragment fragment = (SearchDetailFragment) fm
                        .findFragmentByTag(MainActivity.fragment_tag_search_detail);
                if (null != fragment) {
        ...
        switch (dialogType)
        {
            case MyDialogFragment.ADD_TO_BOOKMARK:
                ...
                mCurrentDialog = MyDialogFragment.newInstance(parentActivity,
                        MyDialogFragment.ADD_TO_BOOKMARK, false, true);
            ...
            case MyDialogFragment.ADD_RESULT:
                ...
                mCurrentDialog = MyDialogFragment.newInstance(parentActivity,
                        MyDialogFragment.ADD_RESULT, bSusscuss, true);
                mCurrentDialog
            ...
            case MyDialogFragment.REMOVE_FROM_BOOKMARK:
                ...
                mCurrentDialog = MyDialogFragment.newInstance(parentActivity,
                        MyDialogFragment.REMOVE_FROM_BOOKMARK, false, true);
            ...
            case MyDialogFragment.REMOVE_RESULT:
                ...
                mCurrentDialog = MyDialogFragment.newInstance(parentActivity,
                        MyDialogFragment.REMOVE_RESULT, bSusscuss, true);
