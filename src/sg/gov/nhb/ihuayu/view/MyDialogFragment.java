...
public class MyDialogFragment extends DialogFragment {
    ...
    public static MyDialogFragment newInstance(Context context, int dialogType, boolean succuss,
            Object param) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (dialogType == NO_INTERNET_CONNETION) {
            ...
            dialog.setMessage(parentActivity.getResources().getString(
                    R.string.dialog_msg_search_hint));
            ...
            ProgressDialog dialog = new ProgressDialog(parentActivity);
            dialog.setMessage(parentActivity.getResources().getString(
                    R.string.dialog_msg_download_hint));
            dialog.setIndeterminate(true);
            dialog.setCancelable(true);
            return dialog;
            ...
            ProgressDialog dialog = new ProgressDialog(parentActivity);
            dialog.setMessage(parentActivity.getResources().getString(
                    R.string.dialog_msg_checking_update_hint));
            dialog.setIndeterminate(true);
            dialog.setCancelable(true);
            return dialog;
                    ...
                    .setTitle(
                            numberOfUpdates
                                    ...
                                    + parentActivity.getResources().getString(
                                            R.string.dialog_msg_update_count_remind))
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton)
                        {
            ...
            final LinearLayout wordslayout_0 = (LinearLayout) dialogView
                    .findViewById(R.id.dialog_words_define_panel_0);
                            ...
                            new ViewTreeObserver.OnGlobalLayoutListener()
                            {
                                ...
                                public void onGlobalLayout()
                                {
                                    ...
                                    for (int i = 0; i < count; i++) {
                                        ...
                                        // LayoutParams(LayoutParams.MATCH_PARENT,maxHeight));
                                    }
