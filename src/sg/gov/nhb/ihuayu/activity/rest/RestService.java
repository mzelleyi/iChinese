...
public class RestService {
    ...
    public List<ContentValues> getDictionary(String lastUpdateTime) throws ClientProtocolException,
    ...
    public HashMap<ContentValues, HashMap<ContentValues, List<ContentValues>>> getScenario(
            String lastUpdateTime) throws ClientProtocolException, IOException, ParseException,
            JSONException {
        long start = System.currentTimeMillis();
        HttpClient client = new DefaultHttpClient();
    ...
    public String getRequestJsonString(String lastUpdateTime) throws ParseException {
        return "{\"rLastDownloadDate\":\"" + lastUpdateTime + "\",\"rAuthToken\":\""
                + AESUtils.encription(KEY, getStandardTimeStr()) + "\"}";
    }

    public String getRequestJsonStringForTesting(String lastUpdateTime) throws ParseException {
        return "{\"rLastDownloadDate\":\"2010-04-01T01S01S01\",\"rAuthToken\":\""
