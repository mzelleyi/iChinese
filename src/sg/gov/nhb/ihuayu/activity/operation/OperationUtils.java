...
public class OperationUtils {
    ...
    private static Dictionary cursorToOneDictionary(Cursor cursor) {
        ...
        for (String name : cursor.getColumnNames()) {
            if ("id".equalsIgnoreCase(name)) {
                ...
                dictionary
                        .setRowid(Integer.parseInt(cursor.getString(cursor.getColumnIndex(name))));
    ...
    public static List<ContentValues> jsonTileToSqliteContentValuesDictionary(JSONArray resultArray)
    ...
    @SuppressWarnings("unchecked")
    public static HashMap<ContentValues, HashMap<ContentValues, List<ContentValues>>> getScenarioFromJsonObject(
